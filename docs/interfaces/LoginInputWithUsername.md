...
[auth/login.ts:11](https://github.com/alexnitta/faunauth/blob/0b7b1e9/src/auth/login.ts#L11)
...
[auth/login.ts:20](https://github.com/alexnitta/faunauth/blob/0b7b1e9/src/auth/login.ts#L20)
...
[auth/login.ts:16](https://github.com/alexnitta/faunauth/blob/0b7b1e9/src/auth/login.ts#L16)
...
[auth/login.ts:34](https://github.com/alexnitta/faunauth/blob/0b7b1e9/src/auth/login.ts#L34)
