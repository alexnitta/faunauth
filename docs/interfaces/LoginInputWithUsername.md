...
[auth/login.ts:15](https://github.com/alexnitta/faunauth/blob/86ceabe/src/auth/login.ts#L15)
...
[auth/login.ts:24](https://github.com/alexnitta/faunauth/blob/86ceabe/src/auth/login.ts#L24)
...
[auth/login.ts:20](https://github.com/alexnitta/faunauth/blob/86ceabe/src/auth/login.ts#L20)
...
[auth/login.ts:38](https://github.com/alexnitta/faunauth/blob/86ceabe/src/auth/login.ts#L38)
