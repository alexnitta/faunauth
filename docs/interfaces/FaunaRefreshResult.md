...
[src/types/auth.ts:62](https://github.com/alexnitta/faunauth/blob/185a6ac/src/types/auth.ts#L62)
...
[src/types/auth.ts:58](https://github.com/alexnitta/faunauth/blob/185a6ac/src/types/auth.ts#L58)
