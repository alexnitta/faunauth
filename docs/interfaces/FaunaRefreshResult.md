...
[src/types/auth.ts:62](https://github.com/alexnitta/faunauth/blob/40cc7e0/src/types/auth.ts#L62)
...
[src/types/auth.ts:58](https://github.com/alexnitta/faunauth/blob/40cc7e0/src/types/auth.ts#L58)
