...
[types/auth.ts:78](https://github.com/alexnitta/faunauth/blob/8cbba2b/src/types/auth.ts#L78)
...
[types/auth.ts:74](https://github.com/alexnitta/faunauth/blob/8cbba2b/src/types/auth.ts#L74)
