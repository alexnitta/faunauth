...
[src/types/auth.ts:93](https://github.com/alexnitta/faunauth/blob/62fa1d8/src/types/auth.ts#L93)
...
[src/types/auth.ts:98](https://github.com/alexnitta/faunauth/blob/62fa1d8/src/types/auth.ts#L98)
