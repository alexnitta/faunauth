...
[src/auth/register.ts:21](https://github.com/alexnitta/faunauth/blob/2cd7813/src/auth/register.ts#L21)
...
[src/auth/register.ts:30](https://github.com/alexnitta/faunauth/blob/2cd7813/src/auth/register.ts#L30)
...
[src/auth/register.ts:26](https://github.com/alexnitta/faunauth/blob/2cd7813/src/auth/register.ts#L26)
...
[src/auth/register.ts:34](https://github.com/alexnitta/faunauth/blob/2cd7813/src/auth/register.ts#L34)
