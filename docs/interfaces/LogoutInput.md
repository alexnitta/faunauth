...
[src/auth/logout.ts:10](https://github.com/alexnitta/faunauth/blob/5f9823a/src/auth/logout.ts#L10)
...
[src/auth/logout.ts:14](https://github.com/alexnitta/faunauth/blob/5f9823a/src/auth/logout.ts#L14)
